...
public class ClientBack_Thread_multi extends JFrame implements ActionListener, Runnable{
	...
	public ClientBack_Thread_multi() {
		setTitle("ClientGuI");
		add("South",jtf);
		add("North",js);
	...
	public void connet() {
		try {
			socket = new Socket("192.168.0.6", 7777); //서버의 아이피와 소켓포트로 접속한다
